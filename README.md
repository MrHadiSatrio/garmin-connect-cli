...
Authentication tokens are managed by the [garminconnect](https://github.com/cyberjunky/python-garminconnect) library and stored in `~/.config/garmin-connect-cli/tokens/`.
